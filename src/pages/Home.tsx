  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 bg-background">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 luxury-text">
              {t("Featured Perfumes")}
            </h2>
            ...
            <>
              ...
              <div className="text-center">
                <Link to="/shop">
                  <Button
                    size="lg"
                    className="px-6 py-4 text-sm bg-primary hover:bg-primary/90 transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    {t("View All Products")}
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-5 bg-card rounded-xl shadow-sm border border-border transition-all duration-300 hover:shadow-md">
