        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
          ...
          >
            {categoriesLoading || collectionsLoading ? (
              ...
              <div className="bg-card rounded-xl shadow-lg p-5 sm:p-6 sticky top-24 border border-border">
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <>
                <motion.div 
                  layout
                  className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6"
                >
                  <AnimatePresence>
                    {(showAllProducts ? products : products.slice(0, itemsPerPage)).map((product, index) => (
                      <motion.div
                        key={product.id}
                ...
                <div className="flex flex-col items-center gap-4">
                  {products.length > itemsPerPage && (
                    <motion.div whileTap={{ scale: 0.95 }}>
                      <Button
                        variant="outline"
                        className="px-8 py-3 text-sm rounded-xl border-border hover:bg-accent/10 flex items-center gap-2"
                        onClick={() => {
                      ...
                      >
                        {showAllProducts ? (
                          ...
                          <>
                            {t("View More")} ({products.length - itemsPerPage} {t("more")})
                  ...
                  {showAllProducts && (
                    <motion.div whileTap={{ scale: 0.95 }}>
                      <Button
                        variant="outline"
                        className="px-5 py-2 text-sm rounded-xl border-border hover:bg-accent/10"
                        onClick={() =>
                          window.scrollTo({ top: 0, behavior: "smooth" })
                        }
                      >
              ...
              <div className="text-center py-20 bg-card rounded-xl border border-border shadow-sm">
                <div className="text-muted-foreground mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-2 luxury-text">
                    {t("No products found")}
                  </h3>
                  <p className="text-sm max-w-md mx-auto px-4 text-muted-foreground">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 max-w-md mx-auto">
                  ...
                  <Button
                    ...
                    className="px-5 py-2 text-sm rounded-xl bg-primary hover:bg-primary/90 transition-colors duration-300"
                  >
                    {t("Reset All Filters")}
                  </Button>
                </div>
